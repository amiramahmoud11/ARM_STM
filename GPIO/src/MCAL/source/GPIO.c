...
Ret_enumerrorStatuse GPIO_SetPin_Value(  volatile GPIO_MEMMAP_t* GPIO_port , u32 GPIO_pin , u32 GPIO_Value_State)
{
    ...
    else
    {
        ...
        {
            Loc_Ret_errorState=GPIO_OK;
            GPIO_port->BSRR=(SET_BIT<<GPIO_pin);
        }
        else if(GPIO_Value_State==REST_BIT)
        {
            Loc_Ret_errorState=GPIO_OK;
            GPIO_port->BSRR=BSRR_SHIFT_MASK<<(SET_BIT<<GPIO_pin);
        }
        else 
        {
            Loc_Ret_errorState=Invalid_inputs;
...
Ret_enumerrorStatuse GPIO_GetPin_Value(  volatile GPIO_MEMMAP_t* GPIO_port , u32 GPIO_pin , u32 GPIO_Value_State)
{
    ...
    else
    {
        ...
        Loc_Ret_errorState=GPIO_OK;
        GPIO_Value_State=((GPIO_port->IDR )>>GPIO_pin)|1;
...
Ret_enumerrorStatuse GPIO_AlternateFunction(  volatile GPIO_MEMMAP_t* GPIO_port , u32 GPIO_pin , u32 GPIO_AltFun)
{
    ...
    else
    {
        ...
        else   
        {
            ...
            u32 Loc_AlterFun_High=GPIO_port->AFRH;
            ...
            GPIO_port->AFRH=Loc_AlterFun_High;
